module.exports = {
  func: async (message, suffix) => {
    message.channel.createMessage("Thanks for the feedback! That's has already been suggested or we already know about it." +
    "\nYou can expect it to be fixed or added in a future update, stay tuned!")
  },
  name: 'known',
