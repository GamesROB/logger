...
module.exports = {
  func: async (message, suffix) => {
    if (!suffix || isNaN(suffix)) return message.channel.createMessage('That isn\'t a valid suffix! Please provide any number between 1 and 10,000.')
    const num = parseInt(suffix)
    if (num < 1 || num > 10000) return message.channel.createMessage('That number is invalid! Please provide a number between 1 and 10,000.')
  ...
  name: 'archive',
  description: 'Makes a log of up to the last 10,000 messages in a channel. Example: archive 100 | archive 1000.',
  category: 'Utility',
  perm: 'manageMessages'
}
